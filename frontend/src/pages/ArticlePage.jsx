        ...
        <div className="min-h-screen bg-base-100 py-12 px-4 sm:px-6 lg:px-8 mt-12">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="bg-base-200 rounded-box p-8 shadow-lg">
                 ...
                 <div className="flex flex-row-reverse px-9 mt-3">
                   <button onClick={()=>setIsComment(!isComment) } className="text-xl text-primary" title="Comments" ><FaRegComment /></button>
                 </div>
                 {
                    isComment && (
                        <div> <CommentsSection contentId={id} commentId={commentId}/> </div>
                    )
                 }
