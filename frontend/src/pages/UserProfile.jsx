...
function UserProfile() {
    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8 mt-15">
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-8">
                <div className="flex-shrink-0 relative">
                    {user ? (
                        <img 
                            src={profilepic || "https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg"}
                            alt="User" 
        ...
        <div className="relative group">
            ...
            {/* <div className="absolute -bottom-7 left-1/2 transform -translate-x-1/2 bg-black text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                Premium Member
            </div> */}
        </div>
    )}
                        ...
                        <div className="flex flex-row-reverse mb-5">
                            <Link to="/user/editprofile" className="text-sm btn btn-sm btn-primary">Edit Profile</Link>
                        </div>
                    </div>
                                ...
                                <ul className="space-y-2">
                                    {following.map((followedUser) => (
                                        <li key={followedUser._id} className="flex justify-between items-center p-2 hover:bg-base-200 rounded">
                                            <div className="flex items-center gap-2" onClick={() => { navigate(`/userprofile/${followedUser._id}`) }}>
                                                <div className="w-8 h-8 rounded-full bg-neutral flex items-center justify-center">
                                                    <span className="text-sm font-bold text-neutral-content">
